...
def load_single_instance_from_line(istest: bool , line: str, word_to_indices_map: Dict, nb_words: int = None) -> Tuple:
    """
    ...
    if istest:
        ...
        reason = string_to_indices(split_line[3], word_to_indices_map, nb_words)
        claim = string_to_indices(split_line[4], word_to_indices_map, nb_words)
        debate_title = string_to_indices(split_line[5], word_to_indices_map, nb_words)
        debate_info = string_to_indices(split_line[6], word_to_indices_map, nb_words)
        ...
        return instance_id, warrant0, warrant1, reason, claim, debate_meta_data
    else:
...
def load_single_file(istest: bool, file_name: str, word_to_indices_map: Dict, nb_words: int = None) -> Tuple:
    """
    ...
    if istest:
        for line in lines:
            ...
            instance_id, warrant0, warrant1, reason, claim, debate_meta_data = \
                load_single_instance_from_line(istest, line, word_to_indices_map, nb_words)
        ...
        return (instance_id_list, warrant0_list, warrant1_list, reason_list, claim_list, debate_meta_data_list)
        ...
        return (instance_id_list, warrant0_list, warrant1_list, correct_label_w0_or_w1_list, reason_list, claim_list,debate_meta_data_list)
